...
chcp 950 >nul
echo ============================================
echo    AI Expert System - Start Admin (Local)
echo ============================================
echo.
...
echo.
echo [INFO] Starting Admin+Stats app (localhost only)...
echo [INFO] Local : http://localhost:8502
echo.
streamlit run frontend\admin_app.py --server.port 8502 --server.address localhost
pause
