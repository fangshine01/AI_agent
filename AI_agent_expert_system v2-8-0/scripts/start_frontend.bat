...
chcp 950 >nul
echo ============================================
echo    AI Expert System - Start Frontend (LAN)
echo ============================================
echo.
...
echo.
echo [INFO] Starting Chat app (LAN accessible)...
echo [INFO] Local   : http://localhost:8501
echo [INFO] Network : http://%NETWORK_IP%:8501
echo.
streamlit run frontend\chat_app.py --server.port 8501 --server.address 0.0.0.0
pause
